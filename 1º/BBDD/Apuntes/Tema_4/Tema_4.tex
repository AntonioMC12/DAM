...
\geometry{top=1.5cm, bottom=2.0cm}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\linewidth]{Ejercicio_1.png}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\linewidth]{Clases_1.png}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\linewidth]{Ejercicio_1_b.png}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\linewidth]{Clases_1_b.png}
